...
impl Game {
    ...
    pub fn crew_moves(&self) -> isize {
        unimplemented!()
    }

    /// The number of moves Units with ships are given each turn.
    pub fn ship_moves(&self) -> isize {
        unimplemented!()
    }
